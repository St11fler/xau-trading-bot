...
def run_pipeline():
    ...
    steps = [
        ("Събиране на данни (collect)", "collect.py", "XAUUSD_data_multiple_timeframes.csv"),  
        ("Обучение на short-term Transformer", "short.py", "scalping_model.keras"),
        ("Обучение на long-term Transformer", "long.py", "longterm_model.keras"),
        ("Генериране на прогнози", "prd.py", None),  # Тук няма явен artifact
        ("Обучение на LightGBM класификатор", "action.py", "action_classifier.pkl"),
        ("Backtest на стратегията", "backtest.py", None),
        ("Пускане на бота (live)", "bot.py", None)
    ]
